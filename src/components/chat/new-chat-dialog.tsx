  ...
  return (
    <>
      <Dialog open={isOpen} onOpenChange={handleDialogChange}>
        <DialogContent className="sm:max-w-4xl h-[402px] flex flex-col p-0">
                          ...
                          return (
                              ...
                              >
                                  <Button
                                      variant="default"
                                      size="icon"
                                      className="h-7 w-7 absolute top-1 left-1 bg-primary text-primary-foreground hover:bg-primary/90"
                                      onClick={(e) => {
                                          e.stopPropagation();
