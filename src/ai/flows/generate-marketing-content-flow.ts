...
const prompt = ai.definePrompt({
  ...
  prompt: `You are a creative and effective marketing assistant. Your task is to generate a set of marketing materials for the following topic.

The output should be professional, engaging, and tailored to attract customers.
